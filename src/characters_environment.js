...
function changeGameStatud(character){
  if(nose_coords[0] != ""&& gameConfig.status==="start" && GameStatus === "start") {
    mario_sounds[5].play();
...
function jumping(character){
	if( (nose_coords[1] < 168&&character.live) || (touchIsDown&&character.live) ){
